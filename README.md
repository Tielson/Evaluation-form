...
The project consists of creating a form using the HTML5 markup language to define the elements, along with CSS3 to style the page.

Project in CodePen: <a href="https://codepen.io/tielson/full/BaYNxXj">Project</a> •
